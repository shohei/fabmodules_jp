...
class path_ord_panel(wx.Panel):
   def __init__(self,parent):
      ...
      # label
      #
      label = wx.StaticText(self,label='ordに変換')
      ...
      # controls
      #
      make = wx.Button(self,label='.ordを生成')
      ...
      row3_sizer.Add(wx.StaticText(row3_panel,label='切削クオリティ'),(0,1),flag=(wx.ALIGN_CENTER_VERTICAL|wx.ALIGN_RIGHT))
