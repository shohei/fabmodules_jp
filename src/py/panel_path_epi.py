...
class path_epi_panel(wx.Panel):
   def __init__(self,parent):
      ...
      #
      sizer_2D.Add(wx.StaticText(self.panel_2D,label='xの最小値 xmin (mm)'),(2,0),flag=wx.ALIGN_RIGHT)
      sizer_2D.Add(wx.StaticText(self.panel_2D,label='yの最小値 ymin (mm)'),(2,1),flag=wx.ALIGN_LEFT)
      #
      ...
      #
      sizer_2D.Add(wx.StaticText(self.panel_2D,label='スピード (%)'),(4,0),flag=wx.ALIGN_RIGHT)
      sizer_2D.Add(wx.StaticText(self.panel_2D,label='割合'),(4,1),flag=wx.ALIGN_LEFT)
      #
      ...
      #
      sizer_3D.Add(wx.StaticText(self.panel_3D,label='最小 z パワー (%)'),(0,0),flag=wx.ALIGN_RIGHT)
      sizer_3D.Add(wx.StaticText(self.panel_3D,label='最大 z パワー (%)'),(0,1),flag=wx.ALIGN_LEFT)
      #
      ...
      #
      sizer_3D.Add(wx.StaticText(self.panel_3D,label='xの最小値 xmin (mm)'),(2,0),flag=wx.ALIGN_RIGHT)
      sizer_3D.Add(wx.StaticText(self.panel_3D,label='yの最小値 ymin (mm)'),(2,1),flag=wx.ALIGN_LEFT)
      #
      ...
      #
      sizer_3D.Add(wx.StaticText(self.panel_3D,label='スピード (%)'),(4,0),flag=wx.ALIGN_RIGHT)
      sizer_3D.Add(wx.StaticText(self.panel_3D,label='割合'),(4,1),flag=wx.ALIGN_LEFT)
      #
