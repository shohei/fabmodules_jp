...
class path_epi_panel(wx.Panel):
   def __init__(self,parent):
      ...
      # label
      #
      label = wx.StaticText(self,label='epiに変換')
      ...
      # send
      #
      self.button = wx.Button(self,label='送信!')
      ...
      # controls
      #
      make = wx.Button(self,label='.epiを生成')
      ...
      #
      sizer_2D.Add(wx.StaticText(self.panel_2D,label='パワー(%)'),(1,0),span=(1,2),flag=wx.ALIGN_CENTER_HORIZONTAL)
      #
      ...
      #
      set_sizer_2D.Add(wx.StaticText(set_panel_2D,label='スピード (%)'),(0,0),flag=wx.ALIGN_RIGHT)
      set_sizer_2D.Add(wx.StaticText(set_panel_2D,label='割合'),(0,1),flag=wx.ALIGN_LEFT)
      #
      ...
      #
      self.top_left_2D = wx.RadioButton(origin_panel_2D,-1,'左移動',(10,10),style=wx.RB_GROUP)
      origin_sizer_2D.Add(self.top_left_2D,(0,0),flag=wx.ALIGN_CENTER_HORIZONTAL)
      origin_sizer_2D.Add(wx.StaticText(origin_panel_2D,label='上面'),(0,1),flag=(wx.ALIGN_CENTER_HORIZONTAL|wx.ALIGN_CENTER_VERTICAL))
      self.top_right_2D = wx.RadioButton(origin_panel_2D,-1,'右移動',(10,10))
      ...
      origin_sizer_2D.Add(wx.StaticText(origin_panel_2D,label='ｘ原点 (mm)'),(1,1),flag=(wx.ALIGN_CENTER_HORIZONTAL|wx.ALIGN_CENTER_VERTICAL))
      self.origin_y_2D = wx.TextCtrl(origin_panel_2D,-1,'10')
      origin_sizer_2D.Add(self.origin_y_2D,(1,2),flag=wx.ALIGN_LEFT)
      #
      self.bottom_left_2D = wx.RadioButton(origin_panel_2D,-1,'左移動',(10,10))
      origin_sizer_2D.Add(self.bottom_left_2D,(2,0),flag=wx.ALIGN_CENTER_HORIZONTAL)
      origin_sizer_2D.Add(wx.StaticText(origin_panel_2D,label='下面'),(2,1),flag=(wx.ALIGN_CENTER_HORIZONTAL|wx.ALIGN_CENTER_VERTICAL))
      self.bottom_right_2D = wx.RadioButton(origin_panel_2D,-1,'右移動',(10,10))
      #
      ...
      #
      set_sizer_3D.Add(wx.StaticText(set_panel_3D,label='最小 z パワー (%)'),(0,0),flag=wx.ALIGN_RIGHT)
      set_sizer_3D.Add(wx.StaticText(set_panel_3D,label='最大 z パワー (%)'),(0,1),flag=wx.ALIGN_LEFT)
      #
      ...
      #
      set_sizer_3D.Add(wx.StaticText(set_panel_3D,label='スピード (%)'),(2,0),flag=wx.ALIGN_RIGHT)
      set_sizer_3D.Add(wx.StaticText(set_panel_3D,label='割合'),(2,1),flag=wx.ALIGN_LEFT)
      #
      ...
      #
      self.top_left_3D = wx.RadioButton(origin_panel_3D,-1,'左移動',(10,10),style=wx.RB_GROUP)
      origin_sizer_3D.Add(self.top_left_3D,(0,0),flag=wx.ALIGN_CENTER_HORIZONTAL)
      origin_sizer_3D.Add(wx.StaticText(origin_panel_3D,label='上面'),(0,1),flag=(wx.ALIGN_CENTER_HORIZONTAL|wx.ALIGN_CENTER_VERTICAL))
      self.top_right_3D = wx.RadioButton(origin_panel_3D,-1,'右移動',(10,10))
      ...
      origin_sizer_3D.Add(wx.StaticText(origin_panel_3D,label='ｘ原点 (mm)'),(1,1),flag=(wx.ALIGN_CENTER_HORIZONTAL|wx.ALIGN_CENTER_VERTICAL))
      self.origin_y_3D = wx.TextCtrl(origin_panel_3D,-1,'10')
      origin_sizer_3D.Add(self.origin_y_3D,(1,2),flag=wx.ALIGN_LEFT)
      #
      self.bottom_left_3D = wx.RadioButton(origin_panel_3D,-1,'左移動',(10,10))
      origin_sizer_3D.Add(self.bottom_left_3D,(2,0),flag=wx.ALIGN_CENTER_HORIZONTAL)
      origin_sizer_3D.Add(wx.StaticText(origin_panel_3D,label='下面'),(2,1),flag=(wx.ALIGN_CENTER_HORIZONTAL|wx.ALIGN_CENTER_VERTICAL))
      self.bottom_right_3D = wx.RadioButton(origin_panel_3D,-1,'右移動',(10,10))
