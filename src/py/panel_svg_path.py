...
class svg_path_panel(wx.Panel):
   def __init__(self,parent):
      ...
      #
      sizer_2D.Add(wx.StaticText(panel_2D,label='縮尺'),(0,1),flag=(wx.ALIGN_CENTER_VERTICAL|wx.ALIGN_RIGHT))
      self.scale_2D = wx.TextCtrl(panel_2D,-1,'1.0')
      sizer_2D.Add(self.scale_2D,(0,2),flag=wx.ALIGN_LEFT)
      #
      sizer_2D.Add(wx.StaticText(panel_2D,label='曲線上の点'),(1,0),flag=(wx.ALIGN_CENTER_VERTICAL|wx.ALIGN_RIGHT))
      ...
      sizer_2D.Add(wx.StaticText(panel_2D,label='パスの解像度'),(1,3),flag=(wx.ALIGN_CENTER_VERTICAL|wx.ALIGN_LEFT))
      #
      ...
      #
      sizer_3D.Add(wx.StaticText(panel_3D,label='縮尺'),(0,1),flag=(wx.ALIGN_CENTER_VERTICAL|wx.ALIGN_RIGHT))
      self.scale_3D = wx.TextCtrl(panel_3D,-1,'1.0')
      sizer_3D.Add(self.scale_3D,(0,2),flag=wx.ALIGN_LEFT)
      #
      sizer_3D.Add(wx.StaticText(panel_3D,label='曲線上の点'),(1,0),flag=(wx.ALIGN_CENTER_VERTICAL|wx.ALIGN_RIGHT))
      ...
      sizer_3D.Add(wx.StaticText(panel_3D,label='パスの解像度'),(1,3),flag=(wx.ALIGN_CENTER_VERTICAL|wx.ALIGN_LEFT))
      #
      sizer_3D.Add(wx.StaticText(panel_3D,label='最小 z 強さ (mm)'),(2,0),flag=(wx.ALIGN_CENTER_VERTICAL|wx.ALIGN_RIGHT))
      ...
      sizer_3D.Add(wx.StaticText(panel_3D,label='最大 z 強さ (mm)'),(2,3),flag=(wx.ALIGN_CENTER_VERTICAL|wx.ALIGN_LEFT))
      #
