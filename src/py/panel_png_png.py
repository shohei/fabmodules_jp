...
class png_png_panel(wx.Panel):
   def __init__(self,parent):
      ...
      threshold_sizer.Add(wx.StaticText(threshold_panel,label='しきい値 (0-1)'),(0,0),flag=(wx.ALIGN_CENTER_VERTICAL|wx.ALIGN_RIGHT))
      ...
      self.interior = wx.RadioButton(type_panel,label='内部',style=wx.RB_GROUP)
      type_sizer.Add(self.interior,(0,0))
      self.distances = wx.RadioButton(type_panel,label='距離')
