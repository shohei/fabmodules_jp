...
class cad_stl_panel(wx.Panel):
   def __init__(self,parent):
      ...
      # label
      #
      label = wx.StaticText(self,label='stlに変換')
      ...
      # controls
      #
      make = wx.Button(self,label='.stlを生成')
      ...
      res_panel_sizer.Add(wx.StaticText(res_panel,label='解像度 (ピクセル数/mm)'),(0,0),flag=wx.ALIGN_RIGHT|wx.ALIGN_CENTER_VERTICAL)
