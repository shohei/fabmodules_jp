...
class path_uni_panel(wx.Panel):
   def __init__(self,parent):
      ...
      # label
      #
      label = wx.StaticText(self,label='uniに変換')
      ...
      # controls
      #
      make = wx.Button(self,label='.uniを生成')
      ...
      row3_sizer.Add(wx.StaticText(row3_panel,label='2D パワー (%)'),(0,0),flag=(wx.ALIGN_CENTER_VERTICAL|wx.ALIGN_RIGHT))
      row3_sizer.Add(wx.StaticText(row3_panel,label='スピード (%)'),(0,1),flag=(wx.ALIGN_CENTER_VERTICAL|wx.ALIGN_RIGHT))
      ...
      row5_sizer.Add(wx.StaticText(row5_panel,label='xの最小値 xmin (mm)'),(0,0),flag=(wx.ALIGN_CENTER_VERTICAL|wx.ALIGN_RIGHT))
      row5_sizer.Add(wx.StaticText(row5_panel,label='yの最小値 ymin (mm)'),(0,1),flag=(wx.ALIGN_CENTER_VERTICAL|wx.ALIGN_RIGHT))
      ...
      row7_sizer.Add(wx.StaticText(row7_panel,label='3D パワー (%)'),(0,0),flag=(wx.ALIGN_CENTER_VERTICAL|wx.ALIGN_RIGHT))
      row7_sizer.Add(wx.StaticText(row7_panel,label='割合'),(0,1),flag=(wx.ALIGN_CENTER_VERTICAL|wx.ALIGN_RIGHT))
