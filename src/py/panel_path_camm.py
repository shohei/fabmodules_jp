...
class path_camm_panel(wx.Panel):
   def __init__(self,parent):
      ...
      #
      self.sizer.Add(wx.StaticText(self,label='力 (g)'),(3,0),flag=(wx.ALIGN_CENTER_HORIZONTAL))
      #
      self.force = wx.TextCtrl(self,-1,'45')
      self.sizer.Add(self.force,(4,0),flag=wx.ALIGN_CENTER_HORIZONTAL)
      #
      self.sizer.Add(wx.StaticText(self,label='速度 (cm/s)'),(5,0),flag=(wx.ALIGN_CENTER_HORIZONTAL))
      #
