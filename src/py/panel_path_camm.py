...
class path_camm_panel(wx.Panel):
   def __init__(self,parent):
      ...
      # label
      #
      label = wx.StaticText(self,label='cammに変換')
      ...
      # controls
      #
      make = wx.Button(self,label='.cammを生成')
      ...
      force_sizer.Add(wx.StaticText(force_panel,label='力 (g)'),(0,0),flag=(wx.ALIGN_RIGHT|wx.ALIGN_CENTER_VERTICAL))
      self.force = wx.TextCtrl(force_panel,-1,'45')
      force_sizer.Add(self.force,(0,1),flag=wx.ALIGN_LEFT)
      #
      force_sizer.Add(wx.StaticText(force_panel,label='速度 (cm/s)'),(1,0),flag=(wx.ALIGN_RIGHT|wx.ALIGN_CENTER_VERTICAL))
      ...
      self.top_left = wx.RadioButton(origin_panel,-1,'左移動',(10,10),style=wx.RB_GROUP)
      origin_sizer.Add(self.top_left,(0,0),flag=wx.ALIGN_CENTER_HORIZONTAL)
      origin_sizer.Add(wx.StaticText(origin_panel,label='上面'),(0,1),flag=(wx.ALIGN_CENTER_HORIZONTAL|wx.ALIGN_CENTER_VERTICAL))
      self.top_right = wx.RadioButton(origin_panel,-1,'右移動',(10,10))
      ...
      origin_sizer.Add(wx.StaticText(origin_panel,label='ｘ原点 (mm)'),(1,1),flag=(wx.ALIGN_CENTER_HORIZONTAL|wx.ALIGN_CENTER_VERTICAL))
      self.origin_y = wx.TextCtrl(origin_panel,-1,'0')
      origin_sizer.Add(self.origin_y,(1,2),flag=wx.ALIGN_LEFT)
      #
      self.bottom_left = wx.RadioButton(origin_panel,-1,'左移動',(10,10))
      origin_sizer.Add(self.bottom_left,(2,0),flag=wx.ALIGN_CENTER_HORIZONTAL)
      self.bottom_left.SetValue(True)
      origin_sizer.Add(wx.StaticText(origin_panel,label='下面'),(2,1),flag=(wx.ALIGN_CENTER_HORIZONTAL|wx.ALIGN_CENTER_VERTICAL))
      self.bottom_right = wx.RadioButton(origin_panel,-1,'右移動',(10,10))
