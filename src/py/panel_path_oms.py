...
class path_oms_panel(wx.Panel):
   def __init__(self,parent):
      ...
      # label
      #
      label = wx.StaticText(self,label='omsに変換')
      ...
      # controls
      #
      make = wx.Button(self,label='.omsを生成')
      ...
      row3_sizer.Add(wx.StaticText(row3_panel,label='速度'),(0,0),flag=(wx.ALIGN_CENTER_VERTICAL|wx.ALIGN_RIGHT))
      ...
      row5_sizer.Add(wx.StaticText(row5_panel,label='加速度'),(0,0),flag=(wx.ALIGN_CENTER_VERTICAL|wx.ALIGN_RIGHT))
      ...
      row7_sizer.Add(wx.StaticText(row7_panel,label='周期'),(0,0),flag=(wx.ALIGN_CENTER_VERTICAL|wx.ALIGN_RIGHT))
