...
class path_g_panel(wx.Panel):
   def __init__(self,parent):
      ...
      # label
      #
      label = wx.StaticText(self,label='gに変換')
      ...
      # controls
      #
      make = wx.Button(self,label='.gを生成')
      ...
      row5_sizer.Add(wx.StaticText(row5_panel,label='切削速度 (mm/s)'),(0,0),flag=(wx.ALIGN_RIGHT))
      row5_sizer.Add(wx.StaticText(row5_panel,label='進入速度 (mm/s)'),(0,1),flag=(wx.ALIGN_LEFT))
      ...
      row7_sizer.Add(wx.StaticText(row7_panel,label='スピンドル速度 (RPM)'),(0,0),flag=(wx.ALIGN_RIGHT))
      row7_sizer.Add(wx.StaticText(row7_panel,label='ジョグの高さ (mm)'),(0,1),flag=(wx.ALIGN_LEFT))
      ...
      row9_sizer.Add(wx.StaticText(row9_panel,label='ツール番号'),(0,0),flag=(wx.ALIGN_RIGHT))
      row9_sizer.Add(wx.StaticText(row9_panel,label='冷却系'),(0,1),flag=(wx.ALIGN_LEFT))
