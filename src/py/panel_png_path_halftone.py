...
class png_path_halftone_panel(wx.Panel):
   def __init__(self,parent):
      ...
      # label
      #
      label = wx.StaticText(self,label='halftone pathに変換')
      ...
      # controls
      #
      make = wx.Button(self,label='.pathを生成')
      make.Bind(wx.EVT_BUTTON,make_path)
      self.sizer.Add(make,(2,0),span=(1,4),flag=wx.ALIGN_CENTER_HORIZONTAL)
      #
      self.sizer.Add(wx.StaticText(self,label='最小スポット半径 (ピクセル数)'),(3,0),flag=(wx.ALIGN_CENTER_VERTICAL|wx.ALIGN_RIGHT))
      self.threshold = wx.TextCtrl(self,-1,'1')
      self.sizer.Add(self.threshold,(3,1))
      #
      self.sizer.Add(wx.StaticText(self,label='スポットあたりの点の数'),(3,2),flag=(wx.ALIGN_CENTER_VERTICAL|wx.ALIGN_RIGHT))
      self.points = wx.TextCtrl(self,-1,'8')
      self.sizer.Add(self.points,(3,3))
      #
      self.sizer.Add(wx.StaticText(self,label='最大スポットサイズ (mm)'),(4,0),flag=(wx.ALIGN_CENTER_VERTICAL|wx.ALIGN_RIGHT))
      self.size = wx.TextCtrl(self,-1,'1')
      self.sizer.Add(self.size,(4,1))
      #
      self.sizer.Add(wx.StaticText(self,label='スポットの間隔 (1でスポットのサイズ)'),(4,2),flag=(wx.ALIGN_CENTER_VERTICAL|wx.ALIGN_RIGHT))
      self.spacing = wx.TextCtrl(self,-1,'1')
      self.sizer.Add(self.spacing,(4,3))
      #
      self.sizer.Add(wx.StaticText(self,label='列のオフセット (1でスポットサイズ)'),(5,0),flag=(wx.ALIGN_CENTER_VERTICAL|wx.ALIGN_RIGHT))
