...
class fab_frame(wx.Frame):
   ...
   def set_png_epi(self):
      self.defaults = {}
      self.control_panel.defaults.Append('ボール紙')
      ...
      self.control_panel.defaults.Append('アクリル')
   ...
   def set_stl_rml(self):
      self.defaults = {}
      self.control_panel.defaults.Append('インチ, 1/8, ワックス, 荒削り')
      ...
      = "self.png_path_panel.diameter_rough.SetValue('3.175');\
         ...
         self.path_type='3D rough';\
         self.update_panels();"
      self.control_panel.defaults.Append('インチ, 1/8, ワックス, 仕上げ')
      ...
      = "self.png_path_panel.diameter_finish.SetValue('3.175');\
         ...
         self.path_type='3D finish';\
         self.update_panels();"
      self.control_panel.defaults.Append('ミリメートル, 1/8, ワックス, 荒削り')
      ...
      = "self.png_path_panel.diameter_rough.SetValue('3.175');\
         ...
         self.path_type='3D rough';\
         self.update_panels();"
      self.control_panel.defaults.Append('ミリメートル, 1/8, ワックス, 仕上げ')
   ...
   def set_png_eps(self):
      self.defaults = {}
      self.control_panel.defaults.Append('輪郭線')
   ...
   def set_png_camm(self):
      self.defaults = {}
      self.control_panel.defaults.Append('ビニール')
      self.defaults["vinyl"]\
      = "self.png_path_panel.error_2D.SetValue('1.5');\
         self.png_path_panel.diameter_2D.SetValue('0.25');\
         ...
         self.path_type = '2D';\
         self.update_panels();"
      self.control_panel.defaults.Append('銅')
      ...
      = "self.png_path_panel.error_2D.SetValue('1.5');\
         ...
         self.path_type = '2D';\
         self.update_panels();"
      self.control_panel.defaults.Append('エポキシ')
      self.defaults["epoxy"]\
      = "self.png_path_panel.error_2D.SetValue('1.5');\
         self.png_path_panel.diameter_2D.SetValue('0.25');\
         self.png_path_panel.number_2D.SetValue('1');\
