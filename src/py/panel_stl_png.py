...
class stl_png_panel(wx.Panel):
   def __init__(self,parent):
      ...
      # label
      #
      label = wx.StaticText(self,label='pngに変換')
      ...
      # controls
      #
      make = wx.Button(self,label='.pngを生成')
      ...
      units_panel_sizer.Add(wx.StaticText(units_panel,label='stlの単位 (mm/unit)'),(0,0),flag=wx.ALIGN_RIGHT|wx.ALIGN_CENTER_VERTICAL)
      ...
      res_panel_sizer.Add(wx.StaticText(res_panel,label='pngの解像度 (ピクセル数/mm)'),(0,0),flag=wx.ALIGN_RIGHT|wx.ALIGN_CENTER_VERTICAL)
      ...
      axis_sizer.Add(wx.StaticText(axis_panel,label='側面:'),(0,0),flag=wx.ALIGN_RIGHT|wx.ALIGN_CENTER_VERTICAL)
