...
class path_plt_panel(wx.Panel):
   def __init__(self,parent):
      ...
      # label
      #
      label = wx.StaticText(self,label='pltに変換')
      ...
      # controls
      #
      make = wx.Button(self,label='.pltを生成')
      ...
      row4_sizer.Add(wx.StaticText(row4_panel,label='切削速度 (mm/s)'),(0,0),flag=(wx.ALIGN_CENTER_VERTICAL|wx.ALIGN_RIGHT))
      row4_sizer.Add(wx.StaticText(row4_panel,label='ジョグの速度 (mm/s)'),(0,1),flag=(wx.ALIGN_CENTER_VERTICAL|wx.ALIGN_RIGHT))
      ...
      row6_sizer.Add(wx.StaticText(row6_panel,label='スピンドル速度 (RPM)'),(0,0),flag=(wx.ALIGN_CENTER_VERTICAL|wx.ALIGN_RIGHT))
      row6_sizer.Add(wx.StaticText(row6_panel,label='ジョグの高さ (mm)'),(0,1),flag=(wx.ALIGN_CENTER_VERTICAL|wx.ALIGN_RIGHT))
