...
class png_path_panel(wx.Panel):
   ...
   def __init__(self,parent):
      ...
      # label
      #
      label = wx.StaticText(self,label='pathに変換')
      ...
      make_button = wx.Button(make_panel,label='.pathを生成')
      ...
      #
      sizer_2D.Add(wx.StaticText(panel_2D,label='直径 (mm)'),(0,0),flag=(wx.ALIGN_RIGHT|wx.ALIGN_CENTER_VERTICAL))
      ...
      sizer_2D.Add(wx.StaticText(panel_2D,label='オフセット (埋め尽くすには-1)'),(0,3),flag=(wx.ALIGN_LEFT|wx.ALIGN_CENTER_VERTICAL))
      #
      sizer_2D.Add(wx.StaticText(panel_2D,label='オーバーラップ (0-1)'),(1,0),flag=(wx.ALIGN_RIGHT|wx.ALIGN_CENTER_VERTICAL))
      ...
      sizer_2D.Add(wx.StaticText(panel_2D,label='誤差 (ピクセル数)'),(1,3),flag=(wx.ALIGN_LEFT|wx.ALIGN_CENTER_VERTICAL))
      #
      sizer_2D.Add(wx.StaticText(panel_2D,label='強さ (0-1)'),(2,1),flag=(wx.ALIGN_RIGHT|wx.ALIGN_CENTER_VERTICAL))
      ...
      #
      sizer_3D_plane.Add(wx.StaticText(panel_3D_plane,label='直径 (mm)'),(0,0),flag=(wx.ALIGN_RIGHT|wx.ALIGN_CENTER_VERTICAL))
      ...
      sizer_3D_plane.Add(wx.StaticText(panel_3D_plane,label='オフセット (埋め尽くすには-1)'),(0,3),flag=(wx.ALIGN_LEFT|wx.ALIGN_CENTER_VERTICAL))
      #
      sizer_3D_plane.Add(wx.StaticText(panel_3D_plane,label='オーバーラップ (0-1)'),(1,0),flag=(wx.ALIGN_RIGHT|wx.ALIGN_CENTER_VERTICAL))
      ...
      sizer_3D_plane.Add(wx.StaticText(panel_3D_plane,label='誤差 (ピクセル数)'),(1,3),flag=(wx.ALIGN_LEFT|wx.ALIGN_CENTER_VERTICAL))
      #
      sizer_3D_plane.Add(wx.StaticText(panel_3D_plane,label='強さ (0-1)'),(2,0),flag=(wx.ALIGN_RIGHT|wx.ALIGN_CENTER_VERTICAL))
      ...
      #
      sizer_3D_rough.Add(wx.StaticText(panel_3D_rough,label='直径 (mm)'),(0,0),flag=(wx.ALIGN_RIGHT|wx.ALIGN_CENTER_VERTICAL))
      ...
      sizer_3D_rough.Add(wx.StaticText(panel_3D_rough,label='オフセット (埋め尽くすには-1)'),(0,3),flag=(wx.ALIGN_LEFT|wx.ALIGN_CENTER_VERTICAL))
      #
      sizer_3D_rough.Add(wx.StaticText(panel_3D_rough,label='オーバーラップ (0-1)'),(1,0),flag=(wx.ALIGN_RIGHT|wx.ALIGN_CENTER_VERTICAL))
      ...
      sizer_3D_rough.Add(wx.StaticText(panel_3D_rough,label='誤差 (ピクセル数)'),(1,3),flag=(wx.ALIGN_LEFT|wx.ALIGN_CENTER_VERTICAL))
      #
      sizer_3D_rough.Add(wx.StaticText(panel_3D_rough,label='上面 強さ (0-1)'),(2,0),flag=(wx.ALIGN_RIGHT|wx.ALIGN_CENTER_VERTICAL))
      ...
      sizer_3D_rough.Add(wx.StaticText(panel_3D_rough,label='上面 z (mm)'),(2,3),flag=(wx.ALIGN_LEFT|wx.ALIGN_CENTER_VERTICAL))
      #
      sizer_3D_rough.Add(wx.StaticText(panel_3D_rough,label='下面 強さ (0-1)'),(3,0),flag=(wx.ALIGN_RIGHT|wx.ALIGN_CENTER_VERTICAL))
      ...
      sizer_3D_rough.Add(wx.StaticText(panel_3D_rough,label='下面 z (mm)'),(3,3),flag=(wx.ALIGN_LEFT|wx.ALIGN_CENTER_VERTICAL))
      #
      sizer_3D_rough.Add(wx.StaticText(panel_3D_rough,label='切削深さ (mm'),(4,1),flag=(wx.ALIGN_LEFT|wx.ALIGN_CENTER_VERTICAL))
      ...
      #
      sizer_3D_finish.Add(wx.StaticText(panel_3D_finish,label='ツール直径 (mm)'),(0,1),flag=(wx.ALIGN_RIGHT|wx.ALIGN_CENTER_VERTICAL))
      self.diameter_finish = wx.TextCtrl(panel_3D_finish,-1,'0.25')
      sizer_3D_finish.Add(self.diameter_finish,(0,2),flag=(wx.ALIGN_LEFT))
      #
      sizer_3D_finish.Add(wx.StaticText(panel_3D_finish,label='オーバーラップ (0-1)'),(1,0),flag=(wx.ALIGN_RIGHT|wx.ALIGN_CENTER_VERTICAL))
      ...
      sizer_3D_finish.Add(wx.StaticText(panel_3D_finish,label='誤差 (ピクセル数)'),(1,3),flag=(wx.ALIGN_LEFT|wx.ALIGN_CENTER_VERTICAL))
      #
      sizer_3D_finish.Add(wx.StaticText(panel_3D_finish,label='上面 強さ (0-1)'),(2,0),flag=(wx.ALIGN_RIGHT|wx.ALIGN_CENTER_VERTICAL))
      ...
      sizer_3D_finish.Add(wx.StaticText(panel_3D_finish,label='上面 z (mm)'),(2,3),flag=(wx.ALIGN_LEFT|wx.ALIGN_CENTER_VERTICAL))
      #
      sizer_3D_finish.Add(wx.StaticText(panel_3D_finish,label='下面 強さ (0-1)'),(3,0),flag=(wx.ALIGN_RIGHT|wx.ALIGN_CENTER_VERTICAL))
      ...
      sizer_3D_finish.Add(wx.StaticText(panel_3D_finish,label='下面 z (mm)'),(3,3),flag=(wx.ALIGN_LEFT|wx.ALIGN_CENTER_VERTICAL))
      #
      sizer_3D_finish.Add(wx.StaticText(panel_3D_finish,label='クリアランス 長さ (mm)'),(4,0),flag=(wx.ALIGN_RIGHT|wx.ALIGN_CENTER_VERTICAL))
      ...
      sizer_3D_finish.Add(wx.StaticText(panel_3D_finish,label='クリアランス 直径 (mm)'),(4,3),flag=(wx.ALIGN_LEFT|wx.ALIGN_CENTER_VERTICAL))
      #
      ...
      sizer_3D_finish_4.Add(wx.StaticText(panel_3D_finish_4,label='方向'),(0,0),flag=(wx.ALIGN_RIGHT|wx.ALIGN_CENTER_VERTICAL))
      ...
      sizer_3D_finish_4.Add(wx.StaticText(panel_3D_finish_4,label='型式'),(0,3),flag=(wx.ALIGN_RIGHT|wx.ALIGN_CENTER_VERTICAL))
