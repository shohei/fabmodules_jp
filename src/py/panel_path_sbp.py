...
class path_sbp_panel(wx.Panel):
   def __init__(self,parent):
      ...
      # label
      #
      label = wx.StaticText(self,label='sbpに変換')
      ...
      # controls
      #
      make = wx.Button(self,label='.sbpを生成')
      ...
      units_sizer.Add(wx.StaticText(units_panel,label='ファイル単位:'),(0,0),flag=(wx.ALIGN_CENTER_VERTICAL|wx.ALIGN_RIGHT))
      self.inches = wx.RadioButton(units_panel,label='インチ',style=wx.RB_GROUP)
      ...
      row6_sizer.Add(wx.StaticText(row6_panel,label='切削速度 (mm/s)'),(0,0),flag=(wx.ALIGN_CENTER_VERTICAL|wx.ALIGN_RIGHT))
      row6_sizer.Add(wx.StaticText(row6_panel,label='ジョグの速度 (mm/s)'),(0,1),flag=(wx.ALIGN_CENTER_VERTICAL|wx.ALIGN_RIGHT))
      ...
      row8_sizer.Add(wx.StaticText(row8_panel,label='スピンドル速度 (RPM)'),(0,0),flag=(wx.ALIGN_CENTER_VERTICAL|wx.ALIGN_RIGHT))
      row8_sizer.Add(wx.StaticText(row8_panel,label='ジョグの高さ (mm)'),(0,1),flag=(wx.ALIGN_CENTER_VERTICAL|wx.ALIGN_RIGHT))
