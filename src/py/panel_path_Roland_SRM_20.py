...
class path_Roland_SRM_20_panel(wx.Panel):
   def __init__(self,parent):
      ...
      # controls
      #
      make = wx.Button(self,label='.rmlを生成')
      ...
      row4_sizer.Add(wx.StaticText(row4_panel,label='スピード (mm/s)'),(0,0),flag=wx.ALIGN_CENTER_HORIZONTAL)
      row4_sizer.Add(wx.StaticText(row4_panel,label='ジョグ (mm)'),(0,1),flag=wx.ALIGN_CENTER_HORIZONTAL)
      ...
      row6_sizer.Add(wx.StaticText(row6_panel,label='xの最小値 xmin (mm)'),(0,0),flag=wx.ALIGN_CENTER_HORIZONTAL)
      row6_sizer.Add(wx.StaticText(row6_panel,label='yの最小値 ymin (mm)'),(0,1),flag=wx.ALIGN_CENTER_HORIZONTAL)
